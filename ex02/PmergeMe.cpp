...
/*   Updated: 2023/03/14 10:57:01 by humartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	PmergeMe::takeArg(char **argv)
{
	int i = 0;
	while (argv[++i] != NULL)
	{
		_vector.push_back( std::atoi(argv[i]) ); // On stocke la valeur dans un vecteur
		_list.push_back( std::atoi(argv[i]) ); // On stocke la valeur dans une liste
	}
}
